...
export type NsToken =
  ...
  // Core semantic / interactive — Figma canonical names
  | '--ns-color-primary'
  | '--ns-color-secondary'
  | '--ns-color-dark'
  | '--ns-color-positive'
  ...
  // Core semantic — legacy status-* aliases
